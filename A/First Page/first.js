$(document).ready(function(){
  ...
  var ctnt = "<a href='A/Second Page/second.html' class='hoverable-text'>In life, the number of beginnings is exactly equal to the number of endings: no one has yet to begin a life who will not end it.</a>"; // Your text goes here
